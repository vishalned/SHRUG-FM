...
sys.path.insert(0, "/home/EarthExtreme-Bench")  # fmt: skip
...
class IMGDataloader:
    ...
    def test_train_dataloader(self):
        return self.get_data_loader(DataLoaderType.TRAIN, batch_size=1)

    def test_val_dataloader(self):
        return self.get_data_loader(DataLoaderType.VAL, batch_size=1)
    ...
    def get_data_loader(
        ...
        dataset_class = disasters[self.disaster]
        dataset = dataset_class(
            split=data_loader_type.value,
            data_path=self.data_path,
            bootstrapping_seed=self.seed,
        )
        return (
            DataLoader(
                dataset=dataset,
